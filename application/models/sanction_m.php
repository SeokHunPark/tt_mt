...
class Sanction_m extends CI_Model
{
	...
	function reg_user($user_id, $code, $s_date, $e_date, $subject, $reason, $memo, $reg_user, $reg_date)
	{
		...
		return $this->db->insert('drag_gamedb.sanction');
	}
	...
	function modify_stage($user_id, $stage)
	{
		...
		return $this->db->update('drag_gamedb.user_challenges');
	}
	
	function delete_user($user_id)
	{
		$this->db->where('user_id', $user_id);
		return $this->db->delete('drag_gamedb.sanction');
	}
}