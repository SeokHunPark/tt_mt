...
class Log_gain_money_m extends CI_Model
{
	...
	{
		// $sql = "select * from drag_logdb.log_gain_money where reg_date between '$begin_date' and '$end_date' order by mail_idx desc";
		// $query = $this->db->query($sql);
		// $result = $query->result();
		// return $result;
